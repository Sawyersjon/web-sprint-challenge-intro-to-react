...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
    ...
    React JS allows us to make changes to only certain parts of the DOM, and keeps it from loading the whole webpage every time there is a change in the data.

1. Describe component state.

  State is data that is managed inside of a component.

1. Describe props.

  Props is data that is passed into a component.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

  A command that happens after the first initial render.  If you want it to render after a change happens to a certain state or prop then you have to add it after the useEffect separated by a comma. 
